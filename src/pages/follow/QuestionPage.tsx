...
export default function QuestionPage() {
    ...
    const handleAutreTexteChange = (e: { target: { value: SetStateAction<string> } }) => {
            ...
            <Card className="bg-card-custom">
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2 text-sm text-gray-950">
                        ...
                        <p>
                            Suite à votre refus de ma candidature au poste de [Nom du poste] au sein de [Nom de la société],
                            je me permets de vous solliciter afin de recueillir votre retour concernant mon profil.
                            Pourriez-vous m’indiquer les raisons pour lesquelles ma candidature n’a pas été retenue ?
                        </p>
                        <p>
                            Ce feedback m’aiderait à mieux comprendre sur quelles compétences/expériences je dois
                            me concentrer pour développer mon profil et ainsi mieux répondre aux attentes du marché.
                        </p>
                        <ol className="list-decimal list-inside space-y-1">
                            <li>Quelles compétences aurais-je pu mieux mettre en avant ?</li>
                            <li>Qu’est-ce qui a manqué dans mon profil, mon expérience, ma lettre de motivation… ?</li>
                        </ol>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <p className="text-sm text-gray-950">
                                Souhaitez-vous être rappelé pour échanger de vive voix sur ma candidature ?
                            </p>
                            <RadioGroup.Root
