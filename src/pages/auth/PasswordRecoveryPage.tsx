...
<>
        ...
        <div className="bg-green-300 md:m-20 m-8">
            <h1 className="font-[var(--font-nunito)] text-center text-3xl md:text-6xl bg-gradient-to-r from-cyan-700 to-blue-950 bg-clip-text text-transparent bord "> Récuperation du mot de passe </h1>
        </div>        
        <Form {...form}>
